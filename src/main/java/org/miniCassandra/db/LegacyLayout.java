...
//import org.miniCassandra.db.partitions.ImmutableBTreePartition;
//import org.miniCassandra.db.rows.*;
//import org.miniCassandra.net.MessagingService;
//import org.miniCassandra.utils.*;
...
//            values[clusteringSize] = columnName.equals(ByteBufferUtil.EMPTY_BYTE_BUFFER)
//                                   ? collectionElement
//                                   : columnName;
//        }
//        else
...
//
//        LegacyRangeTombstoneList rtl = pair.left;
//
...
//        List<LegacyCell> cells = Lists.newArrayList(pair.right);
//
...
//                ByteBufferUtil.writeWithLength(bytes(count), out);
//                continue;
//            }
...
//                size += TypeSizes.sizeof(cell.timestamp);
//                long count = CounterContext.instance().getUpdateCount(cell.value);
//                size += ByteBufferUtil.serializedSizeWithLength(bytes(count));
//                continue;
//            }
//            else if (cell.isCounter())
//            {
...
//                    return Collections.<LegacyCell>emptyIterator();
//
...
//                digest.update(bytes(partitionDeletion.markedForDeleteAt()));
//
...
//             * is done at {@link org.miniCassandra.thrift.ThriftValidation#validateTtl(CFMetaData, Column)}
//             */
