...
import org.miniCassandra.utils.memory.MemoryUtil;
...
public class Memory implements AutoCloseable{private static final Unsafe unsafe;
    static
    {
        try
        {
    ...
    /**
     * create local size of bytes memory
     * @param bytes
     */
