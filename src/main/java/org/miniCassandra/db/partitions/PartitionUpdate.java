...
import org.miniCassandra.utils.NoSpamLogger;
...
//    }
     ...
     *
     * @throws org.miniCassandra.serializers.MarshalException if some of the data contained in this update is corrupted.
     */
...
//                    return LegacyLayout.serializedSizeAsLegacyPartition(null, iter, version);
     ...
     * do. See to understand how this is used.
     */
